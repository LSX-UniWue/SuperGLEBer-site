    ...
    return (
        <article className="py-10">
            ...
            <p className="text-center py-7">
                Below you can find the paper results for the different tasks.
            </p>
            <p className="text-center">
                Note that results for tasks marked with an '*' (Hotel Aspect and WebCAGe) have been updated as
                rerunning, resulted in different outcomes.
            </p>
            <p className="text-center">
                Please be aware that this leaderboard will no longer be updated.
                The new version is available <a href="leaderboard_v1" style={{color: 'cornflowerblue'}}>here</a>.
            </p>
        </article>
    )
}
