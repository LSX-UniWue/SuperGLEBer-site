...
function Intro() {
  return (
    <article className="py-6 sm:py-10 px-2">
      <h1 className="text-3xl sm:text-5xl font-bold text-center py-3 sm:py-5">GermEval 2025</h1>
    </article>
  );
}
  ...
  const data = [
    {
      ...
      metric: "F1",
      split: "29645/ 7412/ 9229",
      more: "https://aclanthology.org/2025.konvens-2.32/",
      license: "",
    },
    {
      id: 2,
      name: "Flausch Tagging",
      topic: "NER",
      metric: "F1",
      split: "29645/ 7412/ 9229",
      more: "https://aclanthology.org/2025.konvens-2.32/",
    ...
    },
    {
      ...
      topic: "Classification",
      metric: "F1",
      split: "4377/ 1095/ 2982",
      more: "https://aclanthology.org/2025.konvens-2.24/",
      license: "",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      topic: "Classification",
      metric: "F1",
      split: "48991/ 10256/ 17999",
      more: "https://sites.google.com/view/llms4subjects-germeval/home",
      license: "",
    },
    {
      id: 7,
      name: "SustainEval Class.",
      topic: "Classification",
      metric: "F1",
      split: "960/ 267/ 473",
      more: "https://aclanthology.org/2025.konvens-2.18/",
      license: "",
    },
    {
      id: 8,
      name: "SustainEval Reg.",
      topic: "Regression",
