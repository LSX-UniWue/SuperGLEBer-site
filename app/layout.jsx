    ...
    <div className="navbar bg-blue-500 text-white relative">
      <div className="flex justify-between items-center w-full">
        <div className="flex items-center">
            ...
            <ul tabIndex="0" className="menu menu-sm dropdown-content mt-3 p-2 rounded-box w-52 bg-base-100 text-base-content shadow-lg" style={dropdownStyle}>
              <li>
                ...
                <ul className="p-2">
                  ...
                  <li>
                    <a href="./sequencetagger">Sequence Tagging</a>
                  </li>
                  <li>
                    <a href="./similarity">Sentence Similarity</a>
                  </li>
                  <li>
          ...
          <a className="btn btn-ghost text-xl" href="./" style={{ fontSize: 25 }}>
            SuperGLEBer
          </a>
        </div>
        <div className="hidden lg:flex">
          <ul className="menu menu-horizontal px-3">
            ...
            <li style={{ fontSize: FONT_HEAD }}>
              <a href="https://aclanthology.org/2024.naacl-long.438/" target="_blank">
                Paper
              </a>
            </li>
            <li style={{ fontSize: FONT_HEAD }}>
              <a href="https://github.com/LSX-UniWue/SuperGLEBer" target="_blank">
                Code
              </a>
            </li>
            <li style={{ fontSize: FONT_HEAD }}>
  ...
  return (
    <footer className="footer items-center p-4 bg-blue-500 text-white">
      <aside className="items-center grid-flow-col">
        ...
        <p>
          <a href="https://www.uni-wuerzburg.de/sonstiges/impressum/" target="_blank">
            Impressum
          </a>{" "}
          - Center for Artificial Intelligence and Data Science (CAIDAS) - Data Science Chair (JMU) -{" "}
          <a href="https://github.com/LSX-UniWue/SuperGLEBer-site/blob/main/LICENSE" target="_blank">
            AGPL-3.0
          </a>
        </p>
      </aside>
