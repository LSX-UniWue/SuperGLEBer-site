...
export function NavBar() {
    return (
        <div className="navbar bg-blue-500 text-white shadow-sm">
            <div className="navbar-start ">
                <div className="dropdown text-white">
                    ...
                    <ul tabIndex="0"
                        className="menu menu-sm dropdown-content mt-3 z-[1] p-2  bg-primary rounded-box w-52">
                        <li>
                            <a>Tasks</a>
                            <ul className="p-2">
    ...
    return (
        <footer className="footer items-center p-4 bg-blue-500 text-white">
            <aside className="items-center grid-flow-col">
                ...
                <p>Copyright © 2024 - All right reserved - <a href="https://www.uni-wuerzburg.de/sonstiges/impressum/" target="_blank">Impressum</a></p>
